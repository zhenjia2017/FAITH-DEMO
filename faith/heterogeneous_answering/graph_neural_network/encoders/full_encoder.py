...
from faith.heterogeneous_answering.graph_neural_network.encoders.encoder import Encoder
...
class FullEncoder(Encoder):
    def __init__(self, config):
        ...
        self.max_entities = config["gnn_max_entities"]
        self.max_evidences = config["gnn_max_evidences"]
